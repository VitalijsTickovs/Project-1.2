...
public class Renderer {
    ...
    public void render(Graphics2D g2) {
        ...
        // Render the terrain
        double camTLx = cam.xPosition - cam.width / 2;
        double camTLy = cam.yPosition - cam.height / 2;
        double camBRx = cam.xPosition + cam.width / 2;
        double camBRy = cam.yPosition + cam.height / 2;
        ...
        g2.fillArc(ballRenderX - 3 * ballWidth / 4, ballRenderY - 3 * ballHeight / 4, 3 * ballWidth / 2,
                3 * ballHeight / 2, 0, 360);
    ...
    public void createTerrainImage() {
        terrainImage = new BufferedImage(
                ...
                (int) ((terrain.bottomRightCorner.y - terrain.topLeftCorner.y) * unitSizePixels
                        + heightRange * unitSizePixels),
        ...
        int targetRenderY = (int) ((terrain.target.position.y - targetHeight - terrain.topLeftCorner.y
                + heightRange / 2) * unitSizePixels);
        ...
        g2.fillPolygon(
                ...
                new int[] { targetRenderY - 2 * unitSizePixels, targetRenderY - 3 * unitSizePixels / 2,
                        targetRenderY - unitSizePixels },
                3);
     ...
     * 
     * @param g2
     *            The Graphics2D object that the function is being drawn to
     * @param x
     ...
     * @param filled
     *            Whether it's a filled circle or just an outline
     */
