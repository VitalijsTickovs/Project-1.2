...
public class CollisionSystem {
    ...
    private static CollisionData getClosestCollisionData(ArrayList<IObstacle> collidesWith, Vector2 currentPosition,
    ...
    private static void bounceBall(BallState state, CollisionData collisionData) {
    ...
    private static void calculatePositionAfterCollision(BallState state, CollisionData collisionData) {
    ...
    private static Vector2 countCollisionPositionMinusRadius(BallState state, CollisionData collisionData) {
    ...
    private static Vector2 handleBallOutOfBounds(BallState state) {
        ...
        if (newPosition.x > PhysicsEngine.terrain.bottomRightCorner.x) {
            ...
            Vector2 intersectionPoint = UtilityClass.findLineIntersection(state.position, newPosition,
                    new Vector2(PhysicsEngine.terrain.bottomRightCorner.x, 0),
                    new Vector2(PhysicsEngine.terrain.bottomRightCorner.x, 1));
            ...
            reverseX = true;
            Vector2 intersectionPoint = UtilityClass.findLineIntersection(state.position, newPosition,
                    new Vector2(PhysicsEngine.terrain.topLeftCorner.x, 0),
                    new Vector2(PhysicsEngine.terrain.topLeftCorner.x, 1));
            if (intersectionPoint != null) {
                newPosition = intersectionPoint;
            } else {
                newPosition = state.position;
        ...
        if (newPosition.y > PhysicsEngine.terrain.bottomRightCorner.y) {
            reverseY = true;
            Vector2 intersectionPoint = UtilityClass.findLineIntersection(state.position, newPosition,
                    new Vector2(0, PhysicsEngine.terrain.bottomRightCorner.y),
                    new Vector2(0, PhysicsEngine.terrain.bottomRightCorner.y));
            if (intersectionPoint != null) {
                newPosition = intersectionPoint;
            } else {
            ...
            reverseY = true;
            Vector2 intersectionPoint = UtilityClass.findLineIntersection(state.position, newPosition,
                    new Vector2(0, PhysicsEngine.terrain.topLeftCorner.y),
                    new Vector2(0, PhysicsEngine.terrain.topLeftCorner.y));
            if (intersectionPoint != null) {
                newPosition = intersectionPoint;
            } else {
